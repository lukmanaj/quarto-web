...
You are most likely to encounter Typst CSS when using libraries that produce HTML tables. Here is a temperature heatmap example using `gt` in R, and Pandas in Python.
