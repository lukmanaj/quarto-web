...
#### R - gt
![](images/typst-table-gt.png)

[gt cars example source](examples/gt-cars.qmd)

#### Python - pandas
![](images/typst-table-pandas.png)

[pandas confusion matrix example source](examples/pandas-confusion-matrix.qmd)
