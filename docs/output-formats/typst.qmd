...
You are most likely to encounter Typst CSS when using libraries that produce HTML tables. Here are a few examples.

*Add tabset here with R flextable/gt, Python pandas examples? When I tried, the R examples cause "Error executing '/usr/local/bin/Rscript': Broken pipe (os error 32)"*

This feature works for the specific combinations of HTML elements and CSS properties shown in the table below:
