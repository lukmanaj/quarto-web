...
-   [Typst 0.11.1](/docs/authoring/tables.qmd#features-available-only-in-html-tables)---Typst tables have feature parity with other formats, with colspans, rowspans, and alignment of individual cells.